...
namespace XIVLauncher.Windows
{
    ...
    public partial class OtpInputDialog : Window
    {
        ...
        private async void OtpInputDialog_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            RecaptchaWebView.CoreWebView2.SetVirtualHostNameToFolderMapping("user.ff14.co.kr", tempDir, Microsoft.Web.WebView2.Core.CoreWebView2HostResourceAccessKind.Allow);
            
            // Navigate to the virtual host
            RecaptchaWebView.Source = new Uri("https://user.ff14.co.kr/recaptcha_page.html");
